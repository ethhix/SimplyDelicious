...
$(document).ready(function () {
  ...
  $(".recipe-page--voting-buttons").on(
    "click",
    ".recipe-page--upvote, .recipe-page--downvote",
    function (event) {
      event.preventDefault();
      event.stopPropagation();

      var $button = $(this);
      // This correctly fetches the recipeID from the parent .voting-buttons element
      var recipeID = $button
        .closest(".recipe-page--voting-buttons")
        .data("recipe-id");
      var isUpvote = $button.hasClass("recipe-page--upvote");
      ...
      if ($button.hasClass("active")) {
        ...
        $button
          .siblings(".recipe-page--upvote, .recipe-page--downvote")
          .removeClass("active");
      }
    ...
    $.ajax({
      ...
      success: function (response) {
        ...
        if (response.status === "success") {
          ...
          var $votingButtons = $(
            '.recipe-page--voting-buttons[data-recipe-id="' + recipeID + '"]'
          );
          $votingButtons
            .find(".recipe-page--upvote .votes-count")
            .text(response.upvotes);
          $votingButtons
            .find(".recipe-page--downvote .votes-count")
